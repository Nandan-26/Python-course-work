...
bill=0
while True:
    prods=input("Enter the products you want to buy (or) Enter [E] to exit: ")
    if prods.upper() == "E":
        print("YOUR BILL :".ljust(20),bill)
        print("Thank you for shopping with us".center(50,"*"))
        break
    else:
        quantity=int(input(f"Enter the quantity of {prods} you want to buy : "))
        bill+=data[prods]*quantity
